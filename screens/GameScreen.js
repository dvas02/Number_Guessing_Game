...
function GameScreen({ userNumber, onGameOver }) {
  ...
  }, [currentGuess, userNumber, onGameOver]); // Whenever any of these things changes, this effect will be re-executed
  

  useEffect(() => {
    minBoundary = 1;
    maxBoundary = 100;
  }, []); // When rendered for the first time again
  ...
  let content = // Default view when screen is vertical (or small width)
  <>
